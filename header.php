...
<head>
    ...
    <style>
    body {
      background-image: url("https://www.chendk.info/usr/themes/jasmine/pictures/P5RBlack.jpg");
    ...
    body::before {
      ...
      width: 100%;
      height: 100%;
      background: rgba(255, 255, 255, 0.85); /* 半透明白色蒙版 */
      z-index: -1;
    }
    </style>
    ...
    <link rel="shortcut icon" href="<?php echo getOptionValueOrDefault(
      "icon",
